...
from contract_preprocess.ir.operations import Index, OperationWithLValue, InternalCall, Operation
from contract_preprocess.ir.utils.utils import LVALUE
...
def compute_dependency(compilation_unit: "CompilationUnit") -> None:
...
def compute_dependency_contract(
    contract: Contract, compilation_unit: "CompilationUnit"
) -> None:
...
def add_dependency(lvalue: Variable, function: Function, ir: Operation, is_protected: bool) -> None:
    ...
    read: Union[List[Union[LVALUE, SolidityVariableComposed]], List[IRVariable]]
