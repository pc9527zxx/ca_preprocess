...
def _convert_type_for_solidity_signature_to_string(
    ...
    if isinstance(types, Type):
        ...
        # But the contract_preprocess type system is not straightforward to manipulate here
...
def convert_type_for_solidity_signature(t: Type, seen: Set[Type]) -> Union[Type, List[Type]]:
    ...
    from contract_preprocess.core.declarations import Contract, Enum, Structure
