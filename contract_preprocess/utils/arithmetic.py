...
from contract_preprocess.utils.integer_conversion import convert_string_to_fraction
...
def convert_subdenomination(
    ...
    raise PreprocessException(f"Subdemonination conversion impossible {decimal_value} {sub}")
...
def _unchecked_arithemtic_usage(function: "Function") -> bool:
    ...
    from contract_preprocess.ir.operations import Binary
