...
from contract_preprocess.core.source_mapping.source_mapping import Source, SourceMapping
...
def get_definition(target: SourceMapping, crytic_compile: CryticCompile) -> Source:
    try:
        ...
        raise PreprocessError(f"get_definition_generic not implemented for {type(target)}") from exc
