...
from contract_preprocess.core.solidity_types.elementary_type import ElementaryType, Int, Uint
from contract_preprocess.ir.variables.variable import IRVariable
from contract_preprocess.utils.arithmetic import convert_subdenomination
from contract_preprocess.utils.integer_conversion import convert_string_to_int


@total_ordering
class Constant(IRVariable):
    def __init__(
        self,
        val: str,
