...
from contract_preprocess.vyper_parsing.ast.types import (
    Module,
    FunctionDef,
    EventDef,
    EnumDef,
...
from contract_preprocess.vyper_parsing.declarations.event import EventVyper
from contract_preprocess.vyper_parsing.declarations.struct import StructVyper
from contract_preprocess.vyper_parsing.variables.state_variable import StateVariableVyper
from contract_preprocess.vyper_parsing.declarations.function import FunctionVyper
from contract_preprocess.core.declarations.function_contract import FunctionContract
from contract_preprocess.core.declarations import Contract, StructureContract, EnumContract, EventContract
...
class ContractVyper:  # pylint: disable=too-many-instance-attributes
    def __init__(
        self, parser: "VyperCompilationUnit", contract: Contract, module: Module
    ) -> None:

        self._contract: Contract = contract
        self._parser: "VyperCompilationUnit" = parser
        self._data = module
    ...
    def _parse_contract_items(self) -> None:
        for node in self._data.body:
            if isinstance(node, FunctionDef):
                ...
                contract_parser = ContractVyper(self._parser, contract, node)
                self._contract.file_scope.contracts[contract.name] = contract
                # pylint: disable=protected-access
                self._parser._underlying_contract_to_parser[contract] = contract_parser
