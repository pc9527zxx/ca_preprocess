...
from contract_preprocess.vyper_parsing.variables.structure_variable import StructureVariableVyper
from contract_preprocess.vyper_parsing.ast.types import StructDef, AnnAssign
