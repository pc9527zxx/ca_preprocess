from contract_preprocess.core.declarations.solidity_variables import SOLIDITY_FUNCTIONS
from contract_preprocess.core.expressions import BinaryOperationType, UnaryOperationType
