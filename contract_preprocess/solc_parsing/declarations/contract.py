...
from contract_preprocess.core.solidity_types import ElementaryType, TypeAliasContract
...
from contract_preprocess.solc_parsing.declarations.event_contract import EventContractSolc
from contract_preprocess.solc_parsing.declarations.function import FunctionSolc
from contract_preprocess.solc_parsing.declarations.modifier import ModifierSolc
from contract_preprocess.solc_parsing.declarations.structure_contract import StructureContractSolc
from contract_preprocess.solc_parsing.exceptions import ParsingError, VariableNotFound
from contract_preprocess.solc_parsing.solidity_types.type_parsing import parse_type
from contract_preprocess.solc_parsing.variables.state_variable import StateVariableSolc
from contract_preprocess.utils.using_for import USING_FOR_KEY
...
class ContractSolc(CallerContextExpression):
    def __init__(
        self, parser: "SolcCompilationUnitParser", contract: Contract, data: Dict[str, Any]
    ) -> None:
        # assert solc_version.startswith('0.4')
    ...
    def _parse_custom_error(self, custom_error: Dict) -> None:
        ...
        ce_parser = CustomErrorSolc(ce, custom_error, self, self._parser)
    ...
    def _parse_modifier(self, modifier_data: Dict) -> None:
        ...
        modif_parser = ModifierSolc(modif, modifier_data, self, self.parser)  # type: ignore
        ...
        self._parser.add_function_or_modifier_parser(modif_parser)
    ...
    def _parse_function(self, function_data: Dict) -> None:
        ...
        func_parser = FunctionSolc(func, function_data, self, self._parser)  # type: ignore
        ...
        self._parser.add_function_or_modifier_parser(func_parser)
    ...
    def _analyze_params_element(  # pylint: disable=too-many-arguments
        ...
        elem_parser = Cls_parser(
            elem, element_parser.function_not_parsed, self, self.parser
        )
        if (
        ...
        self._parser.add_function_or_modifier_parser(elem_parser)
    ...
    def _analyze_params_elements(  # pylint: disable=too-many-arguments,too-many-locals
        ...
        try:
            for father in self._contract.inheritance:
                father_parser = self._parser.underlying_contract_to_parser[father]
    ...
    def _handle_comment(self, attributes: Dict) -> None:
        ...
        And handle custom contract_preprocess comments
