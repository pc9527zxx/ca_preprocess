...
import contract_preprocess.core.expressions.type_conversion
...
from contract_preprocess.core.expressions.assignment_operation import (
    AssignmentOperation,
    AssignmentOperationType,
)
from contract_preprocess.core.expressions.binary_operation import (
    BinaryOperation,
    BinaryOperationType,
)
...
from contract_preprocess.solc_parsing.expressions.find_variable import find_variable
from contract_preprocess.solc_parsing.solidity_types.type_parsing import UnknownType, parse_type
...
def parse_call(
    ...
    contract_preprocess.core.expressions.call_expression.CallExpression,
    contract_preprocess.core.expressions.type_conversion.TypeConversion,
]:
    src = expression["src"]
