...
class UserDefinedType(Type):
    ...
    def storage_size(self) -> Tuple[int, bool]:
        ...
        if isinstance(self._type, Structure):
            # TODO: there's some duplicate logic here and core, can we refactor this?
            slot = 0
            offset = 0
        ...
        raise PreprocessException(to_log)

    def __str__(self) -> str:
        from contract_preprocess.core.declarations.structure_contract import StructureContract
        from contract_preprocess.core.declarations.enum_contract import EnumContract
