...
from contract_preprocess.core.solidity_types.type_alias import TypeAliasTopLevel
...
from contract_preprocess.ir.operations import InternalCall
...
class CompilationUnitWrapper(Context):
    def __init__(self, core: "Core", crytic_compilation_unit: CompilationUnit) -> None:
        super().__init__()
        ...
        self.counter_ir_tuple = 0
        self.counter_ir_temporary = 0
        self.counter_ir_reference = 0
