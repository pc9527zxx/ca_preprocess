...
class UnaryOperationType(Enum):
    ...
    def get_type(operation_type: str, isprefix: bool) -> "UnaryOperationType":
        ...
        raise CoreError(f"get_type: Unknown operation type {operation_type}")
    ...
    def __str__(self) -> str:
        ...
        raise CoreError(f"str: Unknown operation type {self}")
    ...
    def is_prefix(operation_type: "UnaryOperationType") -> bool:
        ...
        raise CoreError(f"is_prefix: Unknown operation type {operation_type}")
