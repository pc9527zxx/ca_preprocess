...
if TYPE_CHECKING:
    ...
    from contract_preprocess.core.declarations import Contract, SolidityVariable, SolidityFunction
    from contract_preprocess.solc_parsing.yul.evm_functions import YulBuiltin
