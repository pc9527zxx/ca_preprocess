...
from contract_preprocess.utils.code_complexity import compute_cyclomatic_complexity
...
class FunctionContract(Function, ContractLevel):
    ...
    def generate_ir_ssa(
        ...
        from contract_preprocess.ir.utils.ssa import add_ssa_ir, transform_ir_vars_to_ssa
        from contract_preprocess.core.dominators.utils import (
