...
from contract_preprocess.utils.integer_conversion import convert_string_to_fraction, convert_string_to_int
...
class ConstantFolding(ExpressionVisitor):
    ...
    def _post_identifier(self, expression: Identifier) -> None:
        ...
        from contract_preprocess.core.declarations.enum import Enum
        from contract_preprocess.core.solidity_types.type_alias import TypeAlias
    ...
    def _post_call_expression(self, expression: expressions.CallExpression) -> None:
        from contract_preprocess.core.declarations.solidity_variables import SolidityFunction
        from contract_preprocess.core.declarations.enum import Enum
        from contract_preprocess.core.solidity_types import TypeAlias
    ...
    def _post_member_access(self, expression: expressions.MemberAccess) -> None:
        ...
        from contract_preprocess.core.solidity_types import UserDefinedType, TypeAlias
