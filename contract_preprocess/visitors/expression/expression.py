...
from contract_preprocess.core.expressions.assignment_operation import AssignmentOperation
...
from contract_preprocess.core.expressions.elementary_type_name_expression import ElementaryTypeNameExpression
...
from contract_preprocess.core.expressions.new_elementary_type import NewElementaryType
from contract_preprocess.core.expressions.tuple_expression import TupleExpression
from contract_preprocess.core.expressions.type_conversion import TypeConversion
from contract_preprocess.core.expressions.unary_operation import UnaryOperation
from contract_preprocess.core.expressions.super_call_expression import SuperCallExpression
from contract_preprocess.core.expressions.super_identifier import SuperIdentifier
from contract_preprocess.core.expressions.self_identifier import SelfIdentifier
    ...
    def _visit_expression(self, expression: Expression) -> None:
        ...
        if expression is not None:
            ...
            if not visitor_method:
                raise PreprocessError(f"Expression not handled: {expression}")
